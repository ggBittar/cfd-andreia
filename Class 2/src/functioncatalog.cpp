...
const QList<NamedFunction> &availableFunctions()
{
    static const QList<NamedFunction> functions = {
        {
            "exp_sum",
            "Somatorio de exp(-x - n*t)",
            "u(x, t, N) = somatorio de n = -N ate N de exp(-x - n*t)",
            exponentialSum
        }
    };
...
QString formulationsHtml()
{
    return QString(
        ...
        "</head>"
        "<body>"
        "<h1>Formulações do Class 2</h1>"
        "<div class='card'>"
        "<h2>Função principal</h2>"
        "<div class='caption'>Equação usada para o campo de velocidade.</div>"
        ...
        "<div class='card'>"
        "<h2>Soma auxiliar</h2>"
        "<div class='caption'>Definição da função auxiliar acumulada.</div>"
        ...
        "</div>"
        "<div class='card'>"
        "<h2>Derivada espacial da soma</h2>"
        "<div class='caption'>Derivada espacial da soma auxiliar.</div>"
        ...
        "<div class='caption'>Contribuição individual de cada índice n.</div>"
